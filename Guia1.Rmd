...
resultado <- entrenarPerceptronM(concentlite, maxEpocas = 500, critFinalizacion = 0.9, nu=0.05,
                                 arquitectura = c(4,1))
...
resultado2 <- entrenarPerceptronM(concentlite[,1:3], maxEpocas = 500, critFinalizacion = 0.9, nu=0.05,
                                 arquitectura = c(4,1), alfa = 0.5)
...
pesosConcentlite <- entrenarPerceptron(datos, maxEpocas = 30, critFinalizacion = 0.9, nu = 0.05)
